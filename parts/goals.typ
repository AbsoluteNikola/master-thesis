...
== Цель исследования
Разработка универсального фреймворка для обобщенного вывода и проверки уточняющих типов, позволяющего стандартизировать интеграцию с SMT-решателями, предоставить универсальные алгоритмы для работы с предикатами и снизить порог вхождения для добавления уточняющих типов в различные языки программирования.
