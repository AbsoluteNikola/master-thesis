...
+ Представлен на листингах выше, где разделены типы и выражения
...
Базой для проверки уточняющих типов является проверка подтипирования @jhala2021refinement, описываемая следующими правилами:
#figure(
  prooftree(
    rule(
      name: [Sub-Base],
